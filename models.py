...
class RegressionModel(Model):
    ...
    def __init__(self):
        ...
        self.w_one = nn.Variable(1, hidden_size)
        self.w_two = nn.Variable(hidden_size, 1)  # have to figure out what the first dimension is
    ...
    def run(self, x, y=None):
        ...
        if y is not None:
            ...
            loss = nn.SquareLoss(graph, add2, y_in)
            return graph
        else:
...
class OddRegressionModel(Model):
    ...
    def __init__(self):
        ...
        self.w_one = nn.Variable(1, self.hidden_size)
        self.w_two = nn.Variable(self.hidden_size, 1)  # have to figure out what the first dimension is
        self.b_one = nn.Variable(1, self.hidden_size)
        self.b_two = nn.Variable(1)
...
class DigitClassificationModel(Model):
    ...
    def __init__(self):
        ...
        self.w_three = nn.Variable(hidden_size_2, 10)
        self.b_one = nn.Variable(1, hidden_size)
        self.b_two = nn.Variable(1, hidden_size_2)
        self.b_three = nn.Variable(1, 10)

        #Double layer
        """
        self.w_one = nn.Variable(784, hidden_size)
        self.b_one = nn.Variable(1, hidden_size)
        self.w_two = nn.Variable(hidden_size, 10)
...
class DeepQModel(Model):
    ...
    def __init__(self):
        ...
        self.w_two = nn.Variable(hidden_size, 2)  # have to figure out what the first dimension is
        self.b_one = nn.Variable(1, hidden_size)
        self.b_two = nn.Variable(1)
